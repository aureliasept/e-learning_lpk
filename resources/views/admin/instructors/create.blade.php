...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" x-data="instructorForm()">
    ...
    <nav class="flex items-center space-x-2 text-sm mb-6">
        ...
        <span class="text-[#d4af37] font-medium">Tambah Baru</span>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-white tracking-wide">Tambah Instruktur Baru</h1>
                <p class="text-sm text-gray-400">Daftarkan pengajar baru ke dalam sistem LPK</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-b from-[#0f172a] to-[#0b1221] border border-[#1e293b] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <form action="{{ route('admin.instructors.store') }}" method="POST" @submit="validateForm($event)" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-[#d4af37] text-xs font-bold uppercase mb-2 tracking-wider">Tempat Lahir</label>
                        <input type="text" name="birth_place" value="{{ old('birth_place') }}" placeholder="Contoh: Bandung"
                            class="w-full bg-[#0b1221] border border-[#1e293b] text-white rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37] placeholder-gray-600 transition-all duration-200">
                </div>
                <div>
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <label class="flex items-center gap-3 bg-[#0b1221]/50 rounded-xl p-4 border border-[#1e293b] cursor-pointer group hover:border-[#d4af37]/50 transition-all">
                        <input type="checkbox" name="is_reguler" value="1" {{ old('is_reguler') ? 'checked' : '' }} 
                    ...
                    <label class="flex items-center gap-3 bg-[#0b1221]/50 rounded-xl p-4 border border-[#1e293b] cursor-pointer group hover:border-[#d4af37]/50 transition-all">
                        <input type="checkbox" name="is_karyawan" value="1" {{ old('is_karyawan') ? 'checked' : '' }} 
                            class="w-5 h-5 rounded border-[#1e293b] text-[#d4af37] focus:ring-[#d4af37] bg-[#0b1221]">
                        <div>
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password" required x-model="password" @input="validatePassword"
            ...
            <div class="mb-8">
                ...
                <input type="text" name="position" value="{{ old('position') }}" placeholder="Contoh: Head Instructor"
                    class="w-full bg-[#0b1221] border border-[#1e293b] text-white rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37] placeholder-gray-600 transition-all duration-200">
            </div>
