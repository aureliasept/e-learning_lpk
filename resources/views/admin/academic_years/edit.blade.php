...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <nav class="flex items-center space-x-2 text-sm mb-6">
        ...
        <span class="text-[#d4af37] font-medium">Edit Periode</span>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-white tracking-wide">Edit Periode</h1>
                <p class="text-sm text-gray-400">Perbarui periode {{ $year->name }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="p-8 space-y-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name', $year->name) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="start_date" value="{{ old('start_date', $year->start_date?->format('Y-m-d')) }}" required
                                class="w-full bg-[#0b1221] border border-[#1e293b] text-white rounded-xl pl-12 pr-4 py-3 focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37] transition-all">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="end_date" value="{{ old('end_date', $year->end_date?->format('Y-m-d')) }}" required
                                class="w-full bg-[#0b1221] border border-[#1e293b] text-white rounded-xl pl-12 pr-4 py-3 focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37] transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-[#0b1221]/50 rounded-xl p-4 border border-[#1e293b]">
                    <label class="flex items-center gap-3 cursor-pointer group">
                        <div class="relative">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $year->is_active ? 1 : 0) ? 'checked' : '' }} 
                                class="peer sr-only">
