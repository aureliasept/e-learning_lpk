...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center space-x-2 text-sm mb-6">
            ...
            <span class="text-[#d4af37] font-medium">Kelas Karyawan</span>
        </nav>
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6 mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white tracking-wide">Kelas Karyawan</h1>
                    <p class="text-sm text-gray-400">Kelola data siswa program karyawan</p>
                </div>
            </div>

            <div class="flex flex-col sm:flex-row gap-3 sm:items-center">
                {{-- Filter Periode & Gelombang --}}
                <form method="GET" action="{{ route('admin.classes.karyawan') }}" class="flex flex-wrap items-center gap-3">
                ...
                {{-- Tombol Tambah --}}
                <a href="{{ route('admin.students.create', ['type' => 'karyawan', 'year' => $selectedYearId]) }}" 
